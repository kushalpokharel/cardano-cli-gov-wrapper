...
fn setup_payment_key_pair(prefix:String, _conf:&Config)->PaymentKeyFile{
...
fn setup_stake_key_pair(prefix:String, _conf:&Config)->StakeKeyFile{
...
fn setup_drep_key_pair(_prefix:String, _conf:&Config)->DrepKeyFile{
    let drep_pubkey = String::from("./files/wallet/drep.pub");
    let drep_privkey = String::from("./files/wallet/drep.priv");
    let drep_certificate:String = String::from("./files/wallet/drep.cert");
    let drep_id:String = String::from("./files/wallet/drep.id");
