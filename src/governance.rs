...
pub mod governance{
  ...
  impl Constitution{
    ...
    pub fn new(governance_action_deposit:u64, proposal_url:String, proposal_hash:String, constitution_url:String, constitution_file:String, out_file:String, constitution:String)->Self{
      Self{
    ...
    pub async fn create_constitution(& mut self)->Result<String, String>{
