...
pub async fn constitution_update(mut tx:Transaction ,wallet:&Wallet, config:&Config, address:String)-> String{
    let mut govaction = Constitution::new(Network::Sancho, 0, String::from("https://shorturl.at/xMS15"), String::from("3d2a9d15382c14f5ca260a2f5bfb645fe148bfe10c1d0e1d305b7b1393e2bd97"), "https://shorturl.at/asIJ6".to_string(), String::from("./files/gov-actions/constitution.txt")  , String::from("./files/gov-actions/constitution.action"), String::from(""));
    ...
    let build_status = tx.build_tx(wallet,String::from("--proposal-file"), config, String::from("./files/gov-actions/constitution.action"), address.clone());
...
pub async fn drep_register(mut tx:Transaction ,wallet:&Wallet, config:&Config, address:String){
    ...
    let build_status = tx.build_tx(wallet, String::from("--certificate-file"), config, String::from("./files/wallet/drep.cert"), address.clone());
...
pub async fn vote_proposal(mut vote_tx:Transaction, action_id:String, wallet:&Wallet, config:&Config, address:String){
    ...
    let build_status = vote_tx.build_tx(wallet, String::from("--vote-file"), config, String::from("./files/vote/vote"), address.clone());
...
pub async fn delegate_drep(mut tx:Transaction ,holder_wallet:&Wallet, drep_wallet:&Wallet, config:&Config, address:String){
    ...
    let build_status = tx.build_tx(holder_wallet, String::from("--certificate-file"), config, String::from("./files/wallet/deleg.cert"), address.clone());
